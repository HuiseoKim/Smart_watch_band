...
int main(void)
{
    double a,b,p,q,x1,y1,hall,r,rafter,magnet,hallafter;
    printf("a,b,p,q,x1,y1,hall,hallafter을 순서대로 입력하시오.");
    scanf("%lf %lf %lf %lf %lf %lf %lf %lf",&a,&b,&p,&q,&x1,&y1,&hall,&hallafter);
    ...
    r=inverse(hall,constant);
    rafter=inverse(hallafter,constant);
    printf("%lf : r\n",r);
    printf("%lf : rafter\n",rafter);
    printf("%lf : delta-r",rafter-r);
...
/// 데이터 8.594 -21.078 30 22 3.008 -21.889 100 50
